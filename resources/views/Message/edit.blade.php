        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" enctype="multipart/form-data" action="{{route('message.update',['message'=>$item->id])}}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="float-right">
                            <a class="btn btn-light" href="{{route('message.index')}}">Cancel</a>
